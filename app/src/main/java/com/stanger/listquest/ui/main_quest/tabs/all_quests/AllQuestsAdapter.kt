...
class AllQuestsAdapter internal constructor(options: FirestoreRecyclerOptions<MainQuestModel>,
                                            val viewModel: MainQuestViewModel,
                                            val resources: Resources,
                                            val userModel: UserModel
) :
    FirestoreRecyclerAdapter<MainQuestModel, AllQuestsAdapter.MyViewHolder>(options) {
...
//        firebaseRepository.deleteFavoriteQuestToFirestore(mainQuestModel, userModel)
    ...
    fun deleteSideQuest(position: Int, boolean: Boolean): MainQuestModel {
        ...
        if(mainQuestModel.favorite) firebaseRepository.deleteFavoriteQuestToFirestore(mainQuestModel, userModel)
